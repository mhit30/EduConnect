...
export const PrivacyPolicyScreen = () => {
    return (
        <Box flex="1" m="4" p="2" safeAreaTop>
            ...
            <ScrollView mt="16">
                <Text>
                    **Privacy Policy** Mohammed Hit built the EduConnect app as
                    an Open Source app. This SERVICE is provided by Mohammed Hit
                    at no cost and is intended for use as is. This page is used
                    ...
                    accessible at EduConnect unless otherwise defined in this
                    Privacy Policy. **Information Collection and Use** For a
                    ...
                    name, email, user uploaded pictures. The information that I
                    ...
                    app * [Google Play
                    Services](https://www.google.com/policies/privacy/) **Log
                    Data** I want to inform you that whenever you use my
                    Service, in a case of an error in the app I collect data and
                    ...
                    the Service, and other statistics. **Cookies** Cookies are
                    files with a small amount of data that are commonly used as
                    ...
                    behalf; * To perform Service-related services; or * To
                    assist us in analyzing how our Service is used. I want to
                    inform users of this Service that these third parties have
                    access to their Personal Information. The reason is to
                    perform the tasks assigned to them on our behalf. However,
                    they are obligated not to disclose or use the information
                    for any other purpose. **Security** I value your trust in
                    ...
                    and I cannot guarantee its absolute security. **Links to
                    Other Sites** This Service may contain links to other sites.
                    If you click on a third-party link, you will be directed to
                    that site. Note that these external sites are not operated
                    by me. Therefore, I strongly advise you to review the
                    Privacy Policy of these websites. I have no control over and
                    assume no responsibility for the content, privacy policies,
                    or practices of any third-party sites or services.
                    **Children’s Privacy** These Services do not address anyone
                    ...
                    the necessary actions. **Changes to This Privacy Policy** I
                    may update our Privacy Policy from time to time. Thus, you
                    ...
                    suggestions about my Privacy Policy, do not hesitate to
                    contact me at htmldev30@gmail.com. This privacy policy page
                    was created at
                    [privacypolicytemplate.net](https://privacypolicytemplate.net)
                    and modified/generated by [App Privacy Policy
